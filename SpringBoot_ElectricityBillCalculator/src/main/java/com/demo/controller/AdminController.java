...
public class AdminController {
	...
	public Bill addUnitsConsumed(@RequestParam("userName") String userName, 
			@RequestParam("password") String password, @RequestParam("consumerId") int consumerId, 
			@RequestParam("year") int year, @RequestParam("month") String month, 
			@RequestParam("unitsConsumed") int unitsConsumed) 
					throws ConsumerNotFoundException, AdminNotFoundException{
