...
public class ConsumerController {
	...
	public List<Bill> getBillsByMonth(@RequestParam("month") String month,
			@RequestParam("year") int year,@RequestParam("consumerId") int consumerId) throws BillNotFoundException {
